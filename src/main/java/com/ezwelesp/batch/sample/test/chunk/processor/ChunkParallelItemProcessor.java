package com.ezwelesp.batch.sample.test.chunk.processor;

import com.ezwelesp.batch.sample.test.domain.User;
import com.ezwelesp.batch.sample.test.domain.UserDetail;
import com.ezwelesp.batch.sample.test.mapper.UserDetailMapper;
